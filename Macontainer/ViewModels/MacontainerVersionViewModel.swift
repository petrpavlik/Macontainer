...
private let logger = Logger(
    subsystem: Bundle.main.bundleIdentifier ?? "com.macontainer",
    category: "MacontainerVersionViewModel")
...
@Observable @MainActor final class MacontainerVersionViewModel {
    ...
    private func checkForUpdates() {
        ...
        Task {
            do {
                ...
                self.isNewVersionAvailable = SemverComparator.isGreaterThan(
    ...
    private func fetchLatestVersion() async throws -> String {
        guard
            let url = URL(
                string: "https://api.github.com/repos/petrpavlik/Macontainer/releases/latest")
        else {
