        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            GroupBox("Container Management") {
                VStack(alignment: .leading, spacing: 12) {
                    HStack {
                        Toggle("Launch Container CLI when app launches", isOn: $launchContainersOnAppLaunch)
            ...
            Text("These settings control how containers are managed when the application starts and stops.")
                .font(.caption)
